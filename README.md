...
Вот как мы решаем, как и когда создавать эти классы вообще? И как правильно понимать эту запись "flex-item large order-4">       2. Я пока вынужденно работаю не на своем ноутбуке, поэтому не устанавливаю на него никаких программ (удобных редакторов кода).
